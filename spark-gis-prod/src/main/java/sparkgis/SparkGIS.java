...
import sparkgis.executionlayer.task.HeatMapTask3D;

//This is SparkGIS3D ---- 3D object ----
public class SparkGIS 
{
	...
	List<HeatMapTask3D> tasks = new ArrayList<HeatMapTask3D>();
	for (String caseID : caseIDs){
	    HeatMapTask3D t =
		new HeatMapTask3D(jobId,
				inputSrc,
				caseID,
				algos,
				pred,
