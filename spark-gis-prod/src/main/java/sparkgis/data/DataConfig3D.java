 ...
 */
public class DataConfig3D implements Serializable
{
    ...
    public DataConfig3D(String caseID){
	this.caseID = caseID;
    }
     ...
     */
    public void setSpaceDimensions(double minX, double minY, double minZ, double maxX, double maxY, double maxZ){
	this.dataMinX = minX;
	this.dataMinY = minY;
        this.dataMinZ = minZ;
	this.dataMaxX = maxX;
